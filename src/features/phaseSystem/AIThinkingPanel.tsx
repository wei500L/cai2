  ...
  return (
    <AnimatePresence>
      {config.aiThinkingVisible ? (
        ...
        >
          <div className="w-[min(92vw,34rem)] border border-[color:rgba(51,170,255,0.42)] bg-[color:rgba(2,6,14,0.86)] p-4 shadow-[0_0_42px_rgba(51,170,255,0.22)] backdrop-blur-sm">
