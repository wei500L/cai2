...
const fixtureEvents: GameEvent[] = [
  ...
  },
  {
    ...
    payload: {
      ...
      morale_shift: 0.08,
      narrative: '铁冠帝国在熔断山口击溃灰烬部族主力，战线向南推进',
      attacker_remaining_troops: 70,
      defender_remaining_troops: 51,
    },
  ...
  },
  {
    ...
    payload: {
      ...
      territory_captured: true,
      morale_shift: 0.12,
      narrative: '灰烬部族旗帜熄灭，灭国记录进入纪元档案',
      attacker_remaining_troops: 62,
      defender_remaining_troops: 0,
    },
